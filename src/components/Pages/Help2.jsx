...
const Help = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://i.pinimg.com/736x/4c/04/77/4c0477d60a3eb3d6515f29a43549b162.jpg')",
      }}
    >
      {/* Dark overlay */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border bg-gray-300/10 text-white rounded-md px-3 py-2 focus:ring-blue-900"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full border bg-gray-300/10 text-white rounded-md px-3 py-2 focus:ring-blue-500"
            ...
            <button
              type="submit"
              className="bg-blue-900 text-black font-medium py-2 px-4 rounded-full hover:bg-black/30 hover:border-4 hover:border-blue-900 hover:text-blue-900 duration-300"
            >
              Send Message
            </button>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white/30 p-6 rounded-lg w-[90%] sm:w-[400px] backdrop-blur-sm">
            ...
            <div className="flex justify-end">
              <button
                className="px-4 py-2 bg-blue-900 text-black rounded-full hover:bg-black/50 hover:border-4 hover:border-blue-900 hover:text-blue-900 duration-300"
